...
if(!empty($_SESSION['usertype'])){
    if(!empty($_FILES['material'])){
       ...
       // echo $sqlPortfolio;
        ...
        $fileTmpName = $_FILES['material']['tmp_name'];
        ...
        if($fileError === 0){
            ...
            if($fileSize < 5000000){
               //add sql to insert in db
                ...
                $fileDestination = 'uploads/material/'.$fileNameNew;
                move_uploaded_file($fileTmpName, $fileDestination);
                $sqlUpdateTimetable = "UPDATE portfolio SET material = '$fileDestination' WHERE idportfolio = '$idportfolio'";
                //echo $sqlUpdateKPI;
                ...
                header("Location: material.php?uploadsuccess");
            }else{
