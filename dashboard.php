    ...
    //get profile data
     ...
     //           $rCSbj = mysqli_fetch_assoc($qryCSbj);
        ...
        <div style="border: solid #C2C2C2 1px;border-radius: 10px;background: white;border-collapse: collapse;" class="cc-content container-fluid">
            ...
            <section class="container" style="max-width:60000px">
            <img class="mySlides" src="img/uitm.ico" style="width:40%">
            <img class="mySlides" src="img/jengka.2.jpg" style="width:40%">
            <img class="mySlides" src="img/6.2.jpg" style="width:40%">
            <img class="mySlides" src="img/5.2.jpg" style="width:40%">
