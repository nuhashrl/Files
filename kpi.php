...
<head>
    ...
    <title>e-Portfolio: Key Performance Index ( KPI )</title>     
...
<div id="content">
    ...
    <div class="container-fluid p-4 text-center" style="background: white; border-radius: 20px;"> 
        <form action="kpi0.php" enctype="multipart/form-data" method = "post" name="auditprofile" autocomplete="off" class="form-horizontal">
            
        <div class="row justify-content-center align-content-center">
            <div class="deshbot col-md-5 align-content-center">
                <p class="h4 text-center" style="font-weight:500;">KEY PERFORMANCE INDEX ( KPI )</p>
            </div>
        </div>
        ...
        <div class="my-3">
            ...
            <div class="form-group col-md-12" id="data-kpi">
                <!--start collapse section-->
                <div class="form-group col-md-12">
                    <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#kpi">VIEW KPI</button>
            ...
            <div class="custom-file py-2 w-75">
                <input type="file" accept="pdf/*" onchange="" name="kpi" class="custom-file-input" required>
                <label for="uploadKpi" class="custom-file-label">Upload KPI File</label>
...
<script type="text/javascript">
    ...
    function showKpi(id){
        ...
        if(value=""){
            ...
            $('#rec-kpi').load("./auto-load-kpi.php", {
                yearSession: value,
                request: "load-kpi"
            });
        }
